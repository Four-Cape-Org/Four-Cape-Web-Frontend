...
const AboutSection = (props) => {
  ...
  return (
    <>
      ...
      <div className='relative lg:mt-[3em] md:mt-[4em] sm:mt-[5em] mt-[7em]'>
        ...
        <div className='relative flex justify-center items-center my-[3em] cursor-pointer'>
          <img src={AdThumbnail} className='lg:w-[80%] md:w-[80%] sm:w-[90%] w-[95%] rounded-md shadow-[35px_35px_10px_-15px_#F82586]' alt="Advertisment Thumbnail" />
